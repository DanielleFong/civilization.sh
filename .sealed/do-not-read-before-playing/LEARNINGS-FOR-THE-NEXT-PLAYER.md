...
The mechanic (Danielle): a domestic route pays **+1 food or +1 production per district at the destination**, by district type; the Government Plaza and the Diplomatic Quarter pay **both**. Policy cards multiply on top. So route yield scales with the destination's district count — a 13-district hub pays every route ~+11, which is why 14 of 16 routes ran into Xi'an, and why the districts doctrine and the routes doctrine are one engine seen from two sides. The recorder logs per-route yields every poll. Build capacity early (Markets, Lighthouses, Harbors, Seaports) and keep it full. Fable ended with 859 gold banked ≈ a full turn of its empire never spent; spend every turn.
